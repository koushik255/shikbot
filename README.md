...
- `/torrent <magnet link | .torrent URL | local .torrent path>` downloads directly with `aria2c` into `/home/koushik/MANGA` without going through the LLM.
